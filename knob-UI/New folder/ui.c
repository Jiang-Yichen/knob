...
void ui_watch_digital_screen_init(void)
{
    ...
    lv_obj_set_width(ui_Image3, LV_SIZE_CONTENT);   /// 181
    lv_obj_set_height(ui_Image3, LV_SIZE_CONTENT);    /// 181
...
void ui_call_screen_init(void)
{
    ...
    lv_obj_set_width(ui_Image4, LV_SIZE_CONTENT);   /// 182
    lv_obj_set_height(ui_Image4, LV_SIZE_CONTENT);    /// 181
...
void ui_weather_2_screen_init(void)
{
    ...
    lv_obj_set_width(ui_Image2, LV_SIZE_CONTENT);   /// 181
    lv_obj_set_height(ui_Image2, LV_SIZE_CONTENT);    /// 182
...
void ui_blood_oxy_screen_init(void)
{
    ...
    lv_obj_set_width(ui_Image6, LV_SIZE_CONTENT);   /// 191
    lv_obj_set_height(ui_Image6, LV_SIZE_CONTENT);    /// 190
...
void ui_Screen1_screen_init(void)
{
    ...
    lv_obj_set_width(ui_Image1, LV_SIZE_CONTENT);   /// 202
