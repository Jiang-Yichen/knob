...
void ui_event_watch_digital(lv_event_t * e)
{
    ...
    if(event_code == LV_EVENT_GESTURE &&  lv_indev_get_gesture_dir(lv_indev_get_act()) == LV_DIR_LEFT) {
        _ui_screen_change(ui_start, LV_SCR_LOAD_ANIM_FADE_ON, 100, 0);
    }
    if(event_code == LV_EVENT_GESTURE &&  lv_indev_get_gesture_dir(lv_indev_get_act()) == LV_DIR_RIGHT) {
        _ui_screen_change(ui_start, LV_SCR_LOAD_ANIM_FADE_ON, 100, 0);
    }
    if(event_code == LV_EVENT_SCREEN_LOAD_START) {
        left_Animation(ui_start, 0);
        right_Animation(ui_start, 0);
        opa_on_Animation(ui_start, 300);
        opa_on_Animation(ui_start, 500);
        opa_on_Animation(ui_start, 400);
    }
...
void ui_event_blood_oxy(lv_event_t * e)
{
    ...
    if(event_code == LV_EVENT_SCREEN_LOAD_START) {
        ...
        opa_on_Animation(ui_start, 200);
        opa_on_Animation(ui_start, 300);
        opa_on_Animation(ui_blood_presure_group, 0);
        top_Animation(ui_start, 100);
    }
    if(event_code == LV_EVENT_GESTURE &&  lv_indev_get_gesture_dir(lv_indev_get_act()) == LV_DIR_TOP) {
...
void ui_start_screen_init(void)
{
    ...
    lv_obj_set_width(ui_Roller1, 222);
    lv_obj_set_height(ui_Roller1, 320);
...
void ui_blood_oxy_screen_init(void)
{
    ...
    lv_obj_set_width(ui_blood_oxygen, 108);
    lv_obj_set_height(ui_blood_oxygen, 80);
    lv_obj_set_x(ui_blood_oxygen, 11);
    lv_obj_set_y(ui_blood_oxygen, -8);
    ...
    lv_obj_set_width(ui_arc_spo2, 213);
    lv_obj_set_height(ui_arc_spo2, 246);
    lv_obj_set_x(ui_arc_spo2, 3);
    lv_obj_set_y(ui_arc_spo2, 19);
    ...
    lv_obj_set_style_bg_img_opa(ui_arc_spo2, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_bg_main_stop(ui_arc_spo2, 0, LV_PART_INDICATOR | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_stop(ui_arc_spo2, 255, LV_PART_INDICATOR | LV_STATE_DEFAULT);
...
void ui_Screen1_screen_init(void)
{
    ...
    lv_img_set_zoom(ui_Image1, 306);

    ui_arc_spo1 = lv_arc_create(ui_Screen1);
    lv_obj_set_width(ui_arc_spo1, 218);
    lv_obj_set_height(ui_arc_spo1, 209);
    lv_obj_set_x(ui_arc_spo1, 5);
    lv_obj_set_y(ui_arc_spo1, 3);
